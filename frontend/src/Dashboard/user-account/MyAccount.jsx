...
const MyAccount = () => {
    ...
    const handleDeleted = (id) => {
        try {
            const res = fetch(`${BASE_URL}/users/${id}`, {
                method: 'DELETE',
                headers: {
                        ...
                        <div className='grid md:grid-cols-3 gap-10'>
                            <div className='pb-[50px] px-[30px] rounded-md'>
                                ...
                                <div className='mt-[50px] md:mt-[100px]'>
                                    ...
                                    <button className=' w-full bg-red-600 mt-4 p-3 text-[16px] leading-7 rounded-md text-white' onClick={() => handleDeleted(userData._id)}>Delete account</button>
                                </div>
                            </div>
