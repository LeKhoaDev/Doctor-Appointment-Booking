...
const socialLinks = [
    {
        path: "https://www.youtube.com/channel/UCk0nDqpxI5DV0NuH34N8Lnw",
        icon: <AiFillYoutube className='group-hover:text-white w-4 h-5' />,
    },
    {
        path: "https://github.com/Chickgun123",
        ...
        <footer>
            <div className='pb-16 pt-10'>
                <div className="container">
                    <div className='flex justify-between flex-col md:flex-row flex-swap gap-[30px]'>
                        <div>
                            <img src={logo} alt="" />
                            <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>
                                Copyright © {year} developed by Team Achievers all right reserved
                            </p>
